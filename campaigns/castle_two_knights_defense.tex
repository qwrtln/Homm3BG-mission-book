...
\textbf{Town Buildings:} \svg{bronze} Dwelling, \svg{silver} Dwelling, Citadel
...
\begin{itemize}
  ...
  \item After defeating the neutral army at the Dragon Utopia, add a random dragon from the \svg{azure} Azure neutral Deck to your army.
