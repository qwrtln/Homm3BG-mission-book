...
\begin{itemize}
  \item The Final Charging Enemy Army appears on the Settlement Field of the F3 Tile.
    This army has 4 \svgeven{movement} per Turn.
\end{itemize}
...
\begin{itemize}
  ...
  \item Enemy Charging Heroes move only 2 \svgeven{movement}. The Final Charging Army moves 4 \svgeven{movement}. They take the shortest
    ...
    else. They also make use of Stables 1 \svgeven{movement} bonus.
...
\begin{table*}[!hb]
  ...
  \hommtable[]{37.5}{
    ...
    \begin{tabularx}{0.95\linewidth}{>{\centering}p{0.12\linewidth}>{\raggedright\arraybackslash}p{0.25\linewidth}>{\centering\arraybackslash}X>{\centering\arraybackslash}p{0.28\linewidth}}
      ...
      \darkcellleft[2.8]{Caslte Charging Army \#1}
      ...
      &
      & \\
      \darkcellleft[2.8]{Caslte Charging Army \#2}
      & \lightcellleft[2.8]{Pack of Champions\\Pack of Zealots\\Few Crusaders\\Few Grifins\\Pack of Halberdiers}
      &
      & \\
