...
\begin{itemize}
  ...
  \item If an Enemy Charging Hero enters a map tile or field that your Main Hero is on (exception is if you are in
    ...
    you have, lose 3 \svg{gold}, gain a negative morale, and randomly discard 1 card from your hand.
...
\vspace*{1em}
\includegraphics[width=0.4\paperwidth, keepaspectratio]{\art/cerberi.png}
