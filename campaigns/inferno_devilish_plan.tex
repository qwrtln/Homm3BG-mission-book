...
\addscenariosection{1}{Inferno Campaign -- Dungeons and Devils}{1. A Devilish Plan}{\images/firewall.png}
...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node at (4.2, -17.8) {\large{{\textbf{\textcolor{darkcandyapplered}{Inferno Map}}}}};
  \node at (4.2, -18.3) {\large{{\textbf{\textcolor{darkcandyapplered}{Tiles}}}}};
\end{tikzpicture}
