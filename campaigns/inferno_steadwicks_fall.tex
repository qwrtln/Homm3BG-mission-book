...
\addscenariosection[subsection]{1}{Inferno Campaign -- Dungeons and Devils}{Steadwick's Fall}{\images/firewall.png}
...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node(map)[anchor=center] at (current page.center) {
    \includegraphics[width=\textwidth]{\_assets/maps/inferno_steadwicks_fall.png}
  };
