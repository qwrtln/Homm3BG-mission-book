...
You lose one Combat encounter with your Main Hero (Surrender costs 10 \svg{gold}, and does not count as a defeat).
...
\vspace*{\fill}
\includegraphics[width=0.4\paperwidth, keepaspectratio]{\art/griffin.png}
\vspace*{\fill}
