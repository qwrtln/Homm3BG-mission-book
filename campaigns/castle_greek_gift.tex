...
\begin{itemize}
  \item ``Few'' Halberdiers, ``Few'' Marksmen
\end{itemize}
...
\begin{itemize}
  \item \textcolor{darkcandyapplered}{Replace the Ghost Dragons and Dread Knights with \svg{bronze} neutral Zombies and Skeletons.}
