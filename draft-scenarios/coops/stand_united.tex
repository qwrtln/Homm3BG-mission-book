...
\begin{itemize}
  ...
  \item During the game, players assemble a shared army. Every player can field Units from the shared army during combat (Shared Units' \svg{map} abilities can be activated each Round by only one player).
  ...
  \item When fighting on Dragon Utopia, one of the Neutral \svgunit{azure} Units is always the Azure Dragon and the neutral army uses the AI Deck. Reshuffle the AI Deck and AI Spell Deck at the end of Combat.
