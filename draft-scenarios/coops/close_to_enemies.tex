...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Take collected Map Tiles from Map and remaining prepared Tiles and shuffle them together
    \item Return Map Tiles to the Map in random order
    \item Remaining Map Tiles creates Shared Pool
  \end{itemize}
\end{itemize}
