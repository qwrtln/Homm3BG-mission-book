...
\begin{itemize}
  ...
  \item P × Far (II--III) Map Tile with the Settlement Field of the same terrain as player's Town.
  \item 3P × Far (II--III) Map Tile without the Settlement Field. Each player takes three Map Tiles of their Faction's terrain with different mines. Each player place two of them on the game board so that they correspond with the map template and are linked together. Each player keeps the last Tile for personal exploration.
\end{itemize}

Place Far (II--III) Map Tiles with Settlements that match your Faction's terrain, ensuring they align with the positions on the map represented by colored Cubes. Each pair of same-colored Cubes represents a Map Tile (I) and its corresponding Far (II--III) Map Tile with a Settlement.
Each player place

\textit{Optional: If you want to spice up the game and deepen the cooperation between players, you can take all Far (II--III) Map Tile without the Settlement Field and place them on map randomly. Create a shared pool for discovery from the remaining Tiles.}
...
\begin{itemize}
  ...
  \item Each player who successfully defended their Town may hire a Secondary Hero for 5 \svg{gold} during this Round. This still requires spending a Population Token.
\end{itemize}
\textbf{\nth{3} Round:}
\begin{itemize}
  \item At the start of the Round, each player discovers one Far (II--III) Map Tile. This Tile may be revealed at no cost, whether drawn from the shared pool or taken from the Map.
\end{itemize}
\textbf{\nth{4} Round:}
\begin{itemize}
...
\textbf{\nth{7} Round:}
\begin{itemize}
  \item During this Round, each player may perform the discard and draw action twice at the start of their turn, instead of the usual once.
\end{itemize}
