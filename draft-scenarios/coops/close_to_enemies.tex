...
\begin{itemize}
  ...
  \item 3P × Far (II--III) Map Tile without the Settlement Field. Each player takes three Map Tiles of their Faction's terrain with gold Mine, crystal Mine and one with anything. Each player shuffle their three Map Tiles and place two of them on the game board so that they correspond with the map template and are linked together. Each player keeps the last Tile for personal exploration.
\end{itemize}
...
\textit{Optional: If you want to spice up the game and deepen the cooperation between players, you can take all Far (II--III) Map Tile without the Settlement Field shuffle them and place them on map randomly lead by map-template. After that, create a shared pool for discovery from the remaining Tiles.}
