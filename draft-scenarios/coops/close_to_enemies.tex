...
\begin{itemize}
  \item \textbf{Personal Pool:} Each player takes remaining 1~×~Far (II--III) Map Tile without a Settlement of the same terrain as player's Town
  \item \textbf{Shared Pool:}
  \begin{itemize}
    \item Remove all Far (II--III) Map Tiles without Settlements from the Map
    \item Shuffle all collected Map Tiles together
    \item Return Map Tiles without Settlements to the Map in random order
    \item After you setup Map Tiles in random order, remaining Map Tiles creates Shared Pool
  \end{itemize}
\end{itemize}
