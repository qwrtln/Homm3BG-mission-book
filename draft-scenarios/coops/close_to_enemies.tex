...
\begin{itemize}
  \item Anytime, any player can spend his Building token and get same actions as he move to Trading post.
...
\subsection*{\MakeUppercase{Timed Events}}
  ...
  \begin{itemize}
   ...
   \item \textbf{\nth{7} Round:}
    \begin{itemize}
      \item After you draw Might and Magic Cards at start of round, you can once discard any number of Cards and draw a same number of Cards.
    \end{itemize}
  \end{itemize}
...
\begin{itemize}
  ...
  \item After you draw an enemy army, you can discard one enemy Unit Card and draw a new Unit of same Tier.
  \item The battle does not cost any extra movement points.
