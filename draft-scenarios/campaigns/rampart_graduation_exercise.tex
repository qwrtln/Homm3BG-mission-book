...
\textbf{Starting Units:} A ``Few'' Centaurs, a ``Few'' Dwarves, a ``Pack'' of Elves and a ``Few'' Pegasi
...
\begin{minipage}{\textwidth}
  ...
  \begin{tikzpicture}[remember picture]
    ...
    \node at (3.2, 0.5) {\large{{\textbf{\textcolor{darkcandyapplered}{``Pack'' of}}}}};
...
\begin{table*}[!hb]
  ...
  \hommtable[]{24}{
    ...
    \begin{tabularx}{0.95\linewidth}{>{\centering}p{0.15\linewidth}>{\raggedright\arraybackslash}X>{\centering\arraybackslash}X>{\centering\arraybackslash}X}
      ...
      & \lightcellleft[2.8]{``Pack'' of Zombies\\``Pack'' of Wraiths\\``Pack'' of Liches\\``Few'' Dread Knights\\Walls and Gate}
      & \lightcellleft[2.8]{1~×~Might \svg{might-yellow} Card\\3~×~Magic \svg{magic-yellow} Card}
      & \lightcellleft[2.8]{1~×~Resurrection\\1~×~Haste\\1~×~Weakness} \\
      \darkcell[2.8]{Inferno}
      & \lightcellleft[2.8]{``Pack'' of Magogs\\``Pack'' of Cerberi\\``Pack'' of Pit Lords\\``Few'' Efreet\\Walls and Gate}
      & \lightcellleft[2.8]{3~×~Might \svg{might-yellow} Card\\1~×~Magic \svg{magic-yellow} Card}
      & \lightcellleft[2.8]{1~×~Fireball} \\
      \darkcell[3.2]{Dungeon}
      & \lightcellleft[3.2]{``Pack'' of Harpies\\``Pack'' of Evil Eyes\\``Pack'' of Medusas\\``Few'' Manticores\\``Few'' Black Dragons\\Walls and Gate}
      & \lightcellleft[3.2]{3~×~Might \svg{might-yellow} Card\\3~×~Magic \svg{magic-yellow} Card}
      & \lightcellleft[3.2]{1~×~Magic Arrow\\1~×~Slow\\1~×~Sorrow} \\
    \end{tabularx}
  }
\end{table*}
