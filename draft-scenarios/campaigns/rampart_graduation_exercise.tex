...
In addition to the Cooperative Mode rules (see page 11, ``Cooperative Mode'' in the Core Mission Book), players must reference the attached \pagetarget{Cooperative Play Rules}{Cooperative Play Rules} specific to this campaign.
...
\begin{itemize}
  ...
  \item The difficulty level of every Combat encounter on all \textbf{Far Map Tiles increases by one} until the end of the Scenario (see page 35, ``Field Difficulty Level Table'' in the Core Rulebook).  % no-check-caps
\end{itemize}
...
\begin{itemize}
 \item If the Necropolis and Inferno Faction Towns have not been captured yet, raiders continue to disrupt your supply lines.
   Lose 10 \svg{gold} from this Round's income.
\end{itemize}

\textbf{\nth{11} Round:}
\begin{itemize}
  \item If the Necropolis and Inferno Faction Towns have not been captured yet, raiders continue to disrupt your supply lines.
    Lose 20 \svg{gold} from this Round's income.
\end{itemize}

\textbf{\nth{13} Round:}
\begin{itemize}
  \item If the Necropolis and Inferno Faction Towns have not been captured yet, raiders continue to disrupt your supply lines.
    Lose 30 \svg{gold} from this Round's income.
\end{itemize}
