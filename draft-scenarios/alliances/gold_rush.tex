...
\addscenariosection{1}{Alliance/Clash/Solo Scenario}{Gold Rush}{\images/gold-mine.png}
...
\begin{itemize}
  \item A ``Pack'' of the most expensive \svg{bronze} Units
...
\begin{center}
  {\transparent{0.2}\includegraphics[width=0.7\linewidth, keepaspectratio]{\art/town_portal.png}}
\end{center}
...
\begin{table*}[b!]
  \hommtable[]{23}{
    ...
    \begin{tabularx}{\linewidth}{p{0.25\linewidth}p{0.71\linewidth}}
      ...
      & \lightcell[1.3]{Combat with Neutral Units cannot be skipped\textsuperscript{\hyperref[fn:combat]{*}}. Take the Grail Token and lose all remaining \svg{movement-yellow}.} \\
    \end{tabularx}
    \medskip
  }
  \phantomsection
...
\begin{center}
  {\transparent{0.2}\includegraphics[width=\linewidth, keepaspectratio]{\art/elemental_conflux.png}}
\end{center}
...
\begin{tikzpicture}
  \node at (0.0, 0.0) {\includegraphics[width=0.6\linewidth]{\maps/gold_rush-solo.png}};
...
\begin{tikzpicture}
  \centering
  \node at (0.0, 0.0) {\includegraphics[width=0.92\linewidth]{\maps/gold_rush-1v1.png}};
...
\begin{tikzpicture}
  \node at (0, 0) {\includegraphics[width=\linewidth]{\maps/gold_rush-2v2.png}};
