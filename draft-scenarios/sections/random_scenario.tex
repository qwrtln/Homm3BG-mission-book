...
\hommtablemulticol[]{18}{
  ...
  \bigskip
  \hspace{-0.7em}
  \begin{tabularx}{0.99\linewidth}{p{1.7em}XXX} & \darkcell[1.4]{Battle Royale} & \darkcell[1.4]{King of the Hill} & \darkcell[1.4]{Capture the Grail} \\    \darkcell[1.4]{S}
    & \lightcell[1.4]{1~× Near (IV-V)}
    & \multirow{3}{*}[5.5ex]{\lightcell[5.3]{1~× Center (VI-VII) with a Dragon Utopia (C1 or C3)}}
    & \multirow{3}{*}[5.5ex]{\lightcell[5.3]{1~× Center (VI-VII) with a\linebreak Grail\linebreak (C2 or C4)}} \\
    \darkcell[2.0]{M}
    & \lightcell[2.0]{\includegraphics[width=0.9\linewidth]{\maps/medium.png}}
    &
    & \\
    \darkcell[1.4]{XL}
