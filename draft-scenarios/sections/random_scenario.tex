...
%   \node at (4.9, -1.1) {\includegraphics[width=0.3\linewidth]{\maps/medium.png}};
% \end{tikzpicture}
\begin{itemize}
  \item 1 × Starting (I) Map Tile
  \item 2 × Far (II-III) Map Tile
...
\hommtablemulticol[]{18}{
  \centering
  \medskip
  \textbf{Central Map Tile(s)}\\
  \bigskip
  \hspace{-0.7em}
  \begin{tabularx}{0.99\linewidth}{p{1.7em}>{\centering\arraybackslash}X>{\centering\arraybackslash}X>{\centering\arraybackslash}X} & \darkcell[1.4]{Battle Royale} & \darkcell[1.4]{King of the Hill} & \darkcell[1.4]{Capture the Grail} \\
    \darkcell[1.4]{S}
    & \lightcell[1.4]{1~× Near (IV-V)}
    & \multirow{3}{*}[5.5ex]{\parbox{\linewidth}{\centering\lightcell[5.35]{1~× Center (VI-VII) with a Dragon Utopia (C1 or C3)}}}
    & \multirow{3}{*}[5.5ex]{\parbox{\linewidth}{\centering\lightcell[5.35]{1~× Center (VI-VII) with a\linebreak Grail\linebreak (C2 or C4)}}} \\
    \darkcell[2.2]{M}
    & \lightcell[2.2]{\includegraphics[width=0.95\linewidth]{\maps/medium.png}}
    &
    & \\
    \darkcell[1.4]{XL}
    & \lightcell[1.4]{1~× Center (VI-VII)}
    &
    & \\
  \end{tabularx}
}
...
\begin{minipage}{\textwidth}
  ...
  \noindent
  \hspace{0.01\textwidth} % Add left margin
  \playerimage{\maps/battle-royale-xl-1.png}{1}%
  \playerarrow{-2.8}{0.2}{60}{castlebg}
  \hfill
  \playerimage{\maps/battle-royale-xl-2.png}{2}%
  \playerarrow{-1.5}{0.2}{160}{infernobg}
  \hfill
  \playerimage{\maps/battle-royale-xl-3.png}{3}
  ...
  \noindent
  \hspace{0.01\textwidth} % Add left margin
  \playerimage{\maps/battle-royale-xl-4.png}{4}%
  \playerarrow{-3.2}{3.2}{-30}{castlebg}
  \hfill
  \playerimage{\maps/battle-royale-xl-5.png}{5}%
  \playerarrow{-0.8}{1.4}{210}{infernobg}
  \hfill
  \playerimage{\maps/battle-royale-xl-6.png}{6}
