...
\hommtablemulticol[]{19}{
  ...
  \bigskip
  \hspace{-0.7em}
  \begin{tabularx}{0.99\linewidth}{p{1.7em}>{\centering\arraybackslash}X>{\centering\arraybackslash}X>{\centering\arraybackslash}X} & \darkcell[1.4]{Battle Royale} & \darkcell[1.4]{King of \phantom{y}the Hill\phantom{y}} & \darkcell[1.4]{Capture \phantom{y}the Grail\phantom{y}} \\
    \darkcell[1.8]{S}
