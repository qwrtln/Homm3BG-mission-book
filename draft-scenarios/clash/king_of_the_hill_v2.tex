...
Players get VPs for:
\begin{itemize}
  \item $R-1$ VPs for starting your turn on ``The Hill'' \textit{Where ($R$ is the number of the current Round.}
...
\begin{itemize}
  ...
  \item \textbf{\nth{3} Round:} Gain Citadel for free. If you already had it, gain 1 VP.
  \item \textbf{\nth{4} Round:} Gain \silver\ dwelling for free. If you already had it, gain 2 VP.
  \item \textbf{\nth{5} Round:} Gain \golden\ dwelling for free. If you already had it, gain 3 VP.
\end{itemize}
...
\begin{itemize}
  ...
  \item In a 2-Player game when a player gains \textbf{x} VP for controlling the Hill, that player also has to distribute \textbf{x} \svg{damage-red} to their Units. The \svg{damage-red} is retained until the next Combat starts.
\end{itemize}
...
\begin{tikzpicture}[overlay, remember picture]
  ...
  \node at (13.5, -5) {\includegraphics[width=0.56\linewidth]{\maps/king_of_the_hill_v2-3p.png}};
  ...
  \node at (4.6, -3.8) {\includegraphics[width=0.54\linewidth]{\maps/king_of_the_hill_v2-2p.png}};
