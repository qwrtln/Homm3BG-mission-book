...
\begin{itemize}
  ...
  \item In a 2-Player game when a player gains \textbf{x} VP for controlling the Hill, that player also has to place 1 \svg{damage-red} to their most expensive Unit.
\end{itemize}
