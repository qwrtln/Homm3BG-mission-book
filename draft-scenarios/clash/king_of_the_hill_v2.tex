...
\begin{tikzpicture}[overlay, remember picture]
  ...
  \node at (13.5, -4) {\includegraphics[width=0.56\linewidth]{\maps/king_of_the_hill_v2-3p.png}};
  ...
  \node at (4.6, -1.8) {\includegraphics[width=0.54\linewidth]{\maps/king_of_the_hill_v2-2p.png}};
