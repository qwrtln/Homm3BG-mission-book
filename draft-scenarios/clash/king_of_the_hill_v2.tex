...
\begin{itemize}
  ...
  \item In a 2-Player game when a player gains \textbf{x} VP for controlling the Hill, that player also has to distribute \textbf{x} \svg{damage-red} to their Units. The \svg{damage-red} is retained until that Unit's next Combat.
\end{itemize}
