...
\addscenariosection{1}{meme Scenario}{qwrtln's cave}{\images/NeuroN Emblem.png}

\begin{multicols*}{2}

\textbf{Author:} Me

\textbf{Source:} Also me

\textit{Sure—send me the story, notes, or topic, and I’ll write 1–2 opening paragraphs that set the scene, establish the context, and lead naturally into the main story.}
...
\textbf{Player Count:} What?

\textbf{Starting Resources:} X \svg{gold}, Y \svg{building_materials}, Z \svg{valuables}

\textbf{Starting Income:} X \svg{gold}, 3 \svg{building_materials}, 1/2 \svg{valuables}
