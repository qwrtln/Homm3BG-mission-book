...
\begin{itemize}
  ...
  \item An Astral Gate cannot be entered from a different Map Tile. When entering an Astral Gate, the Hero is teleported to another random Astral Gate on the Map and arrives on an adjacent Field.
