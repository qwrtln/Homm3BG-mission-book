...
\begin{itemize}
  ...
  \item \textbf{Level VII Settlement:} Resolve ``When you Flag a Settlement'' 3 times.
  \item \textbf{Random Town:} You may recruit one Faction Unit you defeated for half its recruitment cost.
  \item \textbf{Dragon Utopia:} You may recruit one dragon you defeated for half its recruitment cost.
\end{itemize}

\end{multicols}

\begin{tikzpicture}[overlay, remember picture]
  \node[yshift=-12em] at (current page.center) {\includegraphics[width=0.84\linewidth]{\maps/astral_run.png}};
\end{tikzpicture}
