...
\begin{itemize}
  ...
  \item Instead of teleporting randomly, a player may reduce 1 Unit's \svg{health_points} to 0 to choose the destination Astral Gate.
\end{itemize}
  
  \begin{center}
  \vspace*{\fill}
  \includegraphics[width=1.1\linewidth]{\maps/astral_run.png}
...
\begin{itemize}
  ...
  \item \textbf{11 Round game:} Remove P × (IV-V) Map Tiles and replace the (VI-VII) Tile with a (IV-V) Map Tile without Obelisk.
\end{itemize}

\begin{center}
  \vspace*{\fill}
  \vspace*{\fill}
  \includegraphics[width=1.1\linewidth]{\maps/astral_run_short.png}
  \captionof{figure}{\textbf{SHORT GAME MAP LAYOUT}}
  \vspace*{\fill}
\end{center}
