...
\begin{itemize}
  ...
  \item At the start of the next turn, a defeated main Hero may gain +2 \svg{movement}, Empower any Statistic Card from their M\&M Deck, and Search (2) the \silver\ Neutral Deck.
\end{itemize}
