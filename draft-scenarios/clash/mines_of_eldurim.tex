...
\addscenariosection{1}{Clash Scenario}{The Mines of Eldurim}{\images/mines.png}
...
When a player captures their \nth{6} mine or settlement all players -- including that player -- take one final turn. After these turns or at the end of \nth{10} Round the game ends. The player who controls the most mines or settlements is the winner. If there is a tie, the tied player with most \svg{gold} wins.
...
\begin{itemize}
  ...
  \item \textbf{Obelisks:} Choose a Visitable Field from any IV-V Map Tile and gain that Field's reward. \textit{Visitable once per Faction.}
\end{itemize}
