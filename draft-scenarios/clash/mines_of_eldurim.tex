...
When a player captures their \nth{6} mine or settlement, all players -- including that player -- take one final turn. After these turns or at the end of \nth{10} Round the game ends. The player who controls the most mines or settlements is the winner. If case of a tie, the tied player with most \svg{gold} is the winner.
