...
When a player captures their \nth{6} mine all players -- including that player -- take one final turn. After these turns the game ends. The player who controls the most mines is the winner. If there is a tie, the tied player with most \svg{gold} wins.
