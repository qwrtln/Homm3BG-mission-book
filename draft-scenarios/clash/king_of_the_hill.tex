...
\addscenariosection{1}{Clash Scenario}{King of the Hill}{\images/crusader.png}
...
\begin{itemize}
  ...
  \item \textbf{Sanctuary:} Empower a Knowledge Statistic Card \textit{or} gain \svg{morale_positive}. \textit{Visitable once per Faction.}
...
\begin{itemize}
  ...
  \item At the start of the next turn, a defeated main Hero may gain +2 \svg{movement}, Empower any Statistic Card from their M\&M Deck, \textit{and} Search (2) the \silver\ Neutral Deck.
\end{itemize}
