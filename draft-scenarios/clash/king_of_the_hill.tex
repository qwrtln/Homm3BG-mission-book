...
\begin{itemize}
  ...
  \item 1 random Neutral \svgunit{bronze} unit.
\end{itemize}
...
\begin{itemize}
  ...
  \item \svgunit{azure} Units cannot be recruited at any point of the game.
...
\begin{itemize}
  \item After winning a Neutral Combat, you may sacrifice 3 \svgunit{bronze} Units to gain 1 \svgunit{silver} unit you defeated.
  \item At the start of next turn, a defeated main Hero may gain +2 \svg{movement}, Empower any Statistic Card from their M\&M Deck AND Search (2) the \svgunit{silver} Neutral Deck.
\end{itemize}
