...
\begin{itemize}
  ...
  \item The player controlling ``The Hill'' may \svg[8]{pay_v2} 6~\svg{gold} and 6~\svg{building_materials} to gain Walls and Arrow Tower until their next turn.
...
\begin{itemize}
  ...
  \begin{itemize}
    \item You may Search (2) \svg{artifact} and \svg[8]{pay_v2} 6 \svg{gold} for minor, 8 \svg{gold} for major, or 11 \svg{gold} for Relic.
...
\begin{tikzpicture}[overlay, remember picture]
  ...
  \node at (13.5, -4) {\includegraphics[width=0.56\linewidth]{\maps/king_of_the_hill-3p.png}};
  ...
  \node at (4.6, -1.8) {\includegraphics[width=0.54\linewidth]{\maps/king_of_the_hill-2p.png}};
