...
\begin{itemize}
  \item When a player Visits an Obelisk, they may choose to teleport to any other revealed Obelisk. If an Obelisk is not visible, it cannot be teleported to. Teleporting does not cost any \svgeven{movement}.
...
\begin{center}
  \vfill
  \includegraphics[width=0.8\linewidth]{\maps/TreasureIsland_2p.png}
  \captionof{figure}{\textbf{2-PLAYER SCENARIO}}
  \vfill
  \includegraphics[width=\linewidth]{\maps/TreasureIsland_3p.png}
...
For 4 or more players, add more islands.
See 6-player example:

\begin{tikzpicture}[remember picture, overlay]
  \node(bg)[anchor=center, yshift=37em, opacity=0.19] at (current page.south) {
    \includegraphics[width=0.95\paperwidth, keepaspectratio]{\art/orb_of_tempestuous_fire.png}
  };
\end{tikzpicture}
