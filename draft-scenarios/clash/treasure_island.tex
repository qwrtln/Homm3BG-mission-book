...
\begin{center}
  \includegraphics[width=0.8\linewidth]{\maps/TreasureIsland_4p.png}
  \captionof{figure}{\textbf{4-PLAYER SCENARIO}}
  \vfill
  \includegraphics[width=0.8\linewidth]{\maps/TreasureIsland_5p.png}
  \captionof{figure}{\textbf{5-PLAYER SCENARIO}}
  \vfill
  \includegraphics[width=0.8\linewidth]{\maps/TreasureIsland_6p.png}
