...
\textbf{Town Buildings:} \svg{bronze} Dwelling, \svg{silver} Dwelling, Citadel, Mage Guild
...
\begin{itemize}
  \item Each Hero gains +1 \svg{movement}, except for the current bomb carrier.
\end{itemize}
...
\begin{itemize}
  \item The bomb carrier cannot gain extra \svg{movement} from any Card, Town Building, Map Location, or any other effect.
  ...
  \begin{itemize}
    \item If defeated, the Hero does not have to pay their opponent 5 \svg{gold}, nor do they gain \svg{morale_negative}.
  \end{itemize}
...
\begin{itemize}
  \item When first flagged, the Hero gains +1 \svg{movement}.
...
\begin{tikzpicture}[overlay]
  ...
  \centering
  \node at (4.5, -4) {\includegraphics[scale=0.25]{\maps/secret-bomb-stash-2p.png}};
  \node at (4.5, -8) {\footnotesize{\textbf{\MakeUppercase{2-PLAYER SCENARIO}}}};
  \node at (13.5, -4) {\includegraphics[scale=0.25]{\maps/secret-bomb-stash-3p.png}};
  \node at (13, -9) {\footnotesize{\textbf{\MakeUppercase{3-PLAYER SCENARIO}}}};
  \node at (4, -17) {\includegraphics[scale=0.25]{\maps/secret-bomb-stash-4p.png}};
  \node at (4.5, -21.5) {\footnotesize{\textbf{\MakeUppercase{4-PLAYER SCENARIO}}}};
  \node at (13, -16) {\includegraphics[scale=0.25]{\maps/secret-bomb-stash-6p.png}};
