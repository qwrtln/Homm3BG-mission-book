...
\begin{itemize}
  \item 1 × Few \svgunit{bronze} Units of the highest recruitment cost
  \item 1 × Pack \svgunit{bronze} Units of the lowest recruitment cost
\end{itemize}
...
\begin{itemize}
  ...
  \end{itemize}
  \item Dragon Utopias are guarded by 2 \svgunit{azure}-tier dragons and 2 \svgunit{golden}-tier dragons.
