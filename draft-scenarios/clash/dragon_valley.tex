...
\begin{itemize}
  ...
  \item Level VII \textbf{Settlements}: Increase all incomes by 1 space and Draw Cards up to your Hand Limit.
  ...
  \begin{itemize}
    \item Sacrifice any number of Units and recruit one of the defeated Dragons for discount of those sacrificed Units' recruitment cost.
