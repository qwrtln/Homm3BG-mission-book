...
If no player has achieved an immediate victory, the player controlling a Dragon Utopia wins. If both Dragon Utopias are controlled by different players, they draw Cards up to their Hand Limit and start a final Combat. The winner of that Combat wins the game. If no one controls a Dragon Utopia, all players lose.
...
\begin{itemize}
  ...
  \item When fighting a Neutral Combat, players may increase the difficulty level by +1 for an extra 5 \svg{gold} and Search (2) \svg{spellpower} or \svg{artifact}. % no-check-caps
...
\begin{itemize}
  \item \textbf{Grail Token}: When a player gains or starts their turn with Grail Token, gain +1 \svg{morale_positive} and Search (2) \svg{spellpower} or \svg{artifact}. Both Secondary and Main Heroes may gain the Grail Token.
