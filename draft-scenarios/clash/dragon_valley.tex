...
\begin{itemize}
  ...
  \item \bronze\ Dwelling and +2 \svg{gold} \textbf{or} \\ Mage Guild and +1 \svg{valuables}.
\end{itemize}
...
If no player has achieved an immediate victory, the player controlling a Dragon Utopia wins.
