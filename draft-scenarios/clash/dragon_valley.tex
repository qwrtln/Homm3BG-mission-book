...
%  \item On Starting and Far Map Tiles, players can only acquire Basic Spells and Minor Artifacts. % To-do where to acquire expert spells?
  ...
  \item When a Unit is attacked but suffers no \svg{damage-red}, it loses 1 \svg{defense}. That Unit regains all its \svg{defense} after it suffers any \svg{damage-red}.
