...
\begin{itemize}
  ...
  \item[\textbf{End}] \textbf{of \nth{10} Round:} Player(s) whose Main Hero have the least experience roll 2 \svg{resource} dice.
\end{itemize}
...
%  \item On Starting and Far Map Tiles, players can only acquire Basic Spells and Minor Artifacts. % To-do where to acquire expert spells?
  \item When a secondary Hero is gained, that Hero gains +1 \svg{movement} for that Round.
  ...
  \item When fighting a Neutral Combat, a Player may increase the difficulty Level by +1 for an extra 5 \svg{gold} and Search (2) the Artifact or the Spell Deck.
