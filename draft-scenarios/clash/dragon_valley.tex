...
%  \item On Starting and Far Map Tiles, players can only acquire Basic Spells and Minor Artifacts. % To-do where to acquire expert spells?
  ...
  \item Obelisk effect: \textbf{once per Faction}, (per Obelisk) roll one \svg{resource} and draw one Card.
  \item When fighting a Neutral Combat, players may increase the difficulty level by +1 for an extra 5 \svg{gold} and Search (2) the Artifact or the Spell Deck.  % no-check-caps
  ...
  %\item If a player's Main Hero is defeated, that Player may change a Defense Statistic Card to an Empowered Defense Card from his Deck.
  \item Players do not have to pay \svg{gold} after losing a Combat against another Player.
  \item When a Unit is attacked but suffers no \svg{damage-red}, it loses 1 \svg{defense}. That Unit regains all it's \svg{defense} after it suffers any \svg{damage-red}.
  ...
  \begin{itemize}
    ...
    \item Search (3) \svg{spellpower} twice 
    \item Search (3) \svg{artifact} twice.
    %\item Roll 2 \svg{resource} 2 \svg{treasure} and (reroll any \svg{experience}).
  \end{itemize}
...
%  \item When visiting a Dragon Utopia: Reshuffle the Neutral \svgunit{golden} and \svgunit{azure} Decks, then draw from \svgunit{azure} until you get 3 Dragons and choose 2 (+1 on impossible difficulty), AND draw from \svgunit{golden} until you get one Dragon.
  \item Dragon Utopias are guarded by 2 \svgunit{azure} dragons and 2 \svgunit{golden} dragons. 
