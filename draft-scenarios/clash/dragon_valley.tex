...
\begin{minipage}{0.4\paperwidth}
  \centering
  \includegraphics[width=0.36\paperwidth]{\maps/dragon-valley-2p.png}
  \captionof{figure}{\textbf{2-PLAYER SCENARIO}}
\end{minipage}
\begin{minipage}{0.4\paperwidth}
  \centering
  \includegraphics[width=0.36\paperwidth]{\maps/dragon-valley-3p.png}
...
\begin{minipage}{0.4\paperwidth}
  \centering
  \includegraphics[width=0.36\paperwidth]{\maps/dragon-valley-4p.png}
  \captionof{figure}{\textbf{4-PLAYER SCENARIO}}
\end{minipage}
\begin{minipage}{0.4\paperwidth}
  \centering
  \includegraphics[width=0.36\paperwidth]{\maps/dragon-valley-4p-short.png}
  \captionof{figure}{\textbf{4-PLAYER SHORT SCENARIO}}
\end{minipage}
