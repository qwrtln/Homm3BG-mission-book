...
\begin{center}
  \transparent{0.3}{\includegraphics[width=0.5\linewidth, keepaspectratio]{\art/slayer.png}}
\end{center}
...
\begin{tikzpicture}[overlay]
  \centering
  \node at (4.5, -5) {\includegraphics[scale=0.165]{\maps/dragon-valley-4p.png}};
  \node at (4.5, -10) {\footnotesize{\textbf{\MakeUppercase{4-PLAYER SCENARIO}}}};
  \node at (12.1, -14) {\includegraphics[scale=0.165]{\maps/dragon-valley-4p-short.png}};
