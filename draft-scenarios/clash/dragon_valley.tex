...
\begin{itemize}
  \item \textbf{Grail Token}: When a player gains or starts their turn with the Grail Token, they gain +1 \svg{morale_positive} and Search (4) \svg{spellpower} or \svg{artifact}. Both Main and Secondary Heroes may pick up the Grail Token.
