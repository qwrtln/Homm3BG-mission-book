...
\begin{itemize}
  ...
  \end{itemize}
  \item A Dragon Utopia can only be flagged once. A flagged Dragon Utopia is considered to be an empty field to all Players. % or: "Once flagged, it is treated as an empty field for all players."
\end{itemize}
