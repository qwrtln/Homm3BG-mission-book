...
\textbf{Starting Resources:} 12 \svg{gold}, 2 \svg{building_materials}, 1 \svg{valuables}
...
\begin{itemize}
  \item Each player may build the \svg{building_special_tent} building at a discount of 2 \svg{gold} and 2 \svg{building_materials}.
  \item \svg{bronze} Dwelling and 2 \svg{gold} \textbf{or} \\ Mage Guild and 1 \svg{valuables}.
\end{itemize}
