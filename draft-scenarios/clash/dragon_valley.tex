...
\begin{itemize}
  ...
  \item Sanctuary effect: \textbf{once per Faction} +1 \svg{morale_positive} and draw 1 Card.
  \item Obelisk effect: textbf{once per Faction} roll one \svg{resource} and draw one Card.
  ...
  \end{itemize}
  \item When visiting a Dragon Utopia: Reshuffle the \svgunit{gold} and \svgunit{azure} Decks, then draw from \svgunit{azure} until you get 3 Dragons and choose 2, AND draw from \svgunit{gold} until you get one Dragon.
...
\begin{itemize}
  ...
  \item[ \textbf{+1}] -- Scattered Treasure: All players may immediately lose 1 \svgeven{movement} to Search (2) the Artifact Deck.
\end{itemize}
