...
\textbf{\nth{1} Round:}
\begin{itemize}
  \item \nth{1} player gains \svg{morale_negative} Token (for Necropolis, -1 hand size  this turn).
  \item \nth{2} player gains +1 \svgeven{movement}.
  \item All the remaining players gain +1 \svgeven{movement}, and \svg{morale_positive} Token (for Necropolis, +1 hand size this turn).
\end{itemize}
