...
\begin{itemize}
  ...
  \item \nth{2} player gains +1 \svgeven{movement}.
  \item All the remaining players gain +1 \svgeven{movement}, and \svg{morale_positive} Token (for Necropolis, +1 to hand size this turn).
\end{itemize}
