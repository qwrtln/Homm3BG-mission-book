...
\begin{itemize}
  ...
  \item At the start of each Player's turn, players gain Arcane Spikes equal to the number of Obelisks controlled by them.
...
\hommtablemulticol[]{16}{
  \begin{tabularx}{\linewidth}{p{0.24\linewidth}p{0.66\linewidth}}
    ...
    \darkcell[1.8]{1 Spike} & \lightcell[1.8]{\svg{activation-yellow} Deal 1 \svg{damage-yellow} to a target Unit} \\
    \darkcell[1.8]{2 Spikes} & \lightcell[1.8]{\svg{activation-yellow} As above, plus reduce the Unit's \svg{defense-yellow} by 1.} \\
    \darkcell[1.8]{3 Spikes} & \lightcell[1.8]{\svg{ongoing-yellow} As above, plus the Unit has its special ability negated.} \\
  \end{tabularx}
}
