...
\hommtablemulticol[]{16}{
  \begin{tabularx}{0.95\linewidth}{X}
    ...
    \lightcell[3.8]{\svg{ongoing-table} A Unit with an Arcane Spike placed on it has its special ability negated and suffers -1 \svg{defense_yellow} for every\\Arcane Spike on it.} \\
  \end{tabularx}
}
