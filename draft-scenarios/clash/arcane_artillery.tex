...
\textbf{\nth{1} Round:}
\begin{itemize}
  \item All players but the first one gain +1 \svgeven{movement}.
\end{itemize}
...
\begin{itemize}
  ...
  \item Depending on the turn order, players get:
  \begin{itemize}
    \item \nth{1} - \svg{morale_negative} Token (for Necropolis, -1 hand size  this turn)
    \item \nth{2} - no morale
    \item \nth{3} and higher - \svg{morale_positive} Token (for Necropolis, +1 hand size this turn)
  \end{itemize}
  \item If playing in Alliance Mode, add a Gold Unit for each extra alliance member to the Dragon Utopia fight (+1 when 2-people teams, +2 when 3-people teams).\end{itemize}

\vspace{3em}

\begin{center}
  \transparent{0.4}{\includegraphics[width=0.5\linewidth, keepaspectratio]{\art/shield.png}}
\end{center}
