...
\begin{table*}[b!]
  \hommtable[]{23}{
    ...
    \begin{tabularx}{\linewidth}{p{0.25\linewidth}p{0.71\linewidth}}
      ...
      & \lightcell[1.3]{Combat with Neutral Units cannot be skipped\textsuperscript{\hyperref[fn:combat]{*}}. Take the Grail Token and lose all remaining \svgeven{movement-yellow}.} \\
    \end{tabularx}
    \medskip
  }
  \phantomsection
