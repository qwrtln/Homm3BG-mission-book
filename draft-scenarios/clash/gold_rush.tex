...
\begin{table*}[t]
  ...
  \phantomsection
  \label{fn:bonus}
  \footnotesize{\textsuperscript{**} For example: if you choose increasing \svg{valuables} production, you increase it by two and get 10 \svg{valuables} if you are first player to Flag this settlement. If you choose reinforcement, you may reinforce two Units.}
\end{table*}
