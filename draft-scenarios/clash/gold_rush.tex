...
\begin{center}
  {\transparent{0.2}\includegraphics[width=0.7\linewidth, keepaspectratio]{\art/elemental_conflux.png}}
\end{center}
...
Players must pay tranches at the start of specific Rounds\footnote{The transhes are paid \textbf{after} other Round-beginning effects, including receiving resources or Astrologers Card}, as shown in the table below. After paying, \textbf{remove all Black Cubes} from every Windmill and Water Wheel on the map.
