...
\begin{table*}[t]
  ...
  \footnotesize{** For example: if you choose increasing \svg{valuables} production, you increase it by two levels and get 10 \svg{valuables} if you are first player to Flag this settlement. If you choose reinforcement, you may reinforce two units.}
\end{table*}
