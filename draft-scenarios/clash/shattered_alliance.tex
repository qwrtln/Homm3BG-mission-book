...
\textbf{\nth{2} Round:}
\begin{itemize}
  \item Each player may gain one reward from the Field that the closest player to them visits this Round.
\end{itemize}
\textbf{\nth{4} Round:}
\begin{itemize}
...
\textbf{\nth{6} Round:}
\begin{itemize}
  \item Secondary Heroes gain +1 \svgeven{movement}.
\end{itemize}
\textbf{\nth{8} Round:}
\begin{itemize}
  \item Each player may remove up to 5 Black Cubes from the map.
\end{itemize}
\textbf{\nth{9} Round:}
\begin{itemize}
  \item Player(s) whose Main Hero has the least \svg{experience} roll 2 \svg{resource}.
\end{itemize}
\textbf{\nth{10} Round:}
\begin{itemize}
...
\textbf{\nth{12} Round:}
\begin{itemize}
  \item Each player may recruit one \silver\ Neutral Unit from the closest player's Faction for half its recruitment cost.
\end{itemize}
...
\begin{itemize}
  ...
  \item If you start a turn with the Grail Token, gain \svg{morale_positive} \textit{and} 5 \svg{gold}. If a Hero with the Grail Token is defeated, the Grail Token is given to the winner of that Combat.
  ...
  \item Level VII Neutral Combats cannot be skipped and grant the player \svg{morale_positive}.
  \item Players do not have to pay \svg{gold} after losing a Combat against another player.
  \item A defeated Main Hero may Empower one Statistic Card from their hand or Discard Pile \textit{and} gain \svg{morale_positive}.
