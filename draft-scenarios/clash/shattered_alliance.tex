...
\textbf{Starting Resources:} 13 \svg{gold}, 1 \svg{building_materials}, 1 \svg{valuables}
...
\begin{itemize}
  \item 2 × Chosen Neutral \svg{bronze} Units from the closest starting player's Faction
\end{itemize}
...
\begin{itemize}
  \item One player has defeated every opponent's Main Hero at least once. \textit{That player wins the game immediately.}
...
\textbf{\nth{7} Round:}
\begin{itemize}
  \item Each player may recruit one Neutral \svg{silver} Unit from their closest starting player's Faction for half its recruitment cost.
\end{itemize}
\textbf{\nth{11} Round:}
\begin{itemize}
...
\begin{itemize}
  \item Each player may, once per Round, replace one Neutral Unit with a Neutral Unit of the same tier from their own Faction when their closest starting player starts a Level I–III combat.
