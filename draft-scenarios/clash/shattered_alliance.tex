...
\begin{itemize}
  ...
  \item 1 VP for Controlling Dragon Utopia, Random Town or level VII Settlement
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Random Town:} On next Resource Round, you may recruit one Unit from that Faction by paying its full recruitment cost.
  ...
  \item \textbf{Level VII Settlement:} You may Reinforce \textbf{and} increase 1 income.
