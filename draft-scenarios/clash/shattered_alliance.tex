...
\begin{itemize}
  \item 2 × chosen Neutral \bronze\ Units from the closest starting player's Faction
\end{itemize}
...
If no player has achieved immediate victory, the player with the most Victory Points (VPs) wins. Players gain VPs as follows:
\begin{itemize}
  ...
  \item 1 VP for possessing the Grail Token
\end{itemize}
...
\textbf{\nth{10} Round:}
\begin{itemize}
  \item Repeat the event of Round 5.
\end{itemize}
\textbf{\nth{11} Round:}
\begin{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Dragon Utopia:} Defended only by Dragons. Recruit one Neutral Dragon you defeated for half its recruitment cost (rounded up). Trading Post conversion may be used for this.
...
\begin{itemize}
  ...
  \item With fewer than 6 players, Starting Towns of unused Factions are defended similarly to a Random Town. Increase 2 different incomes by one space.
