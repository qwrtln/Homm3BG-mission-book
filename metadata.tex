...
\renewcommand{\labelitemi}{
  \begin{tikzpicture}
    \node (listdot) [circle, blur shadow={fill=camel, shadow yshift=0pt, shadow xshift=0pt, shadow blur radius=2.5pt, shadow blur steps=10}, inner sep=-1.5] {\includegraphics[width=0.7em, valign=c]{\layout/listdot.png}};
  \end{tikzpicture}
}
