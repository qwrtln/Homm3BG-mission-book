...
\begin{itemize}
  ...
  \item The final battle with the Dragon occurs at the center field of the Center Map tile.
    Please refer to the encouter rules specified in the ruls of the selected Dragon Boss.
  ...
  \item Players can visit each Obelisk only once.
    Aferwards, they must place their Faction cube on the field.
  \item In the boss encounter, there is no battle round limit.
\end{itemize}

\begin{tikzpicture}[overlay]
  \centering
  \node at (14, 8) {\includegraphics[scale=0.45]{\_assets/maps/the-hunt-2.png}};
  \node at (14, 2) {\footnotesize{\textbf{\MakeUppercase{2-PLAYER SCENARIO}}}};
  \node at (10, -5) {\includegraphics[scale=0.45]{\_assets/maps/the-hunt-3.png}};
  \node at (9, -11.5) {\footnotesize{\textbf{\MakeUppercase{3-PLAYER SCENARIO}}}};
\end{tikzpicture}
