...
\begin{center}
    \textbf{13 ×} \svg{gold}   \textbf{2 ×}   \svg{building_materials}   \textbf{1 ×} \svg{valuables}
\end{center}
\subsection*{\MakeUppercase{Setting a Player's\\Income}}
Set the income on the income tracker to:
\begin{center}
    \textbf{“10”} \svg{gold}   \textbf{“0”}   \svg{building_materials}   \textbf{“0”} \svg{valuables}
\end{center}
...
\begin{itemize}
    \item 1 × A few \svg{bronze} units with the highest Recruitment cost
    \item 1 × A pack of \svg{bronze} units with the lowest Recruitment cost
\end{itemize}
...
\begin{itemize}
    ...
    \item A Hero with the Grail token who possesses the title of “\textcolor{cyan}{Grail Knight}” may pay 10 \svg{gold} or 3 \svg{valuables} at any Temple map location to cleanse the Grail. Place a blue faction cube on the Grail token to mark this effect.
    \item Once cleansed, the Grail token behaves like a Permanent card that does not count towards your hand limit and cannot be discarded; it grants the following effect when played: “$\infty$ Once during each Combat round, if the Hero is a \textcolor{cyan}{Grail Knight}, discard a card to remove up to 2 \svg{damage} from your units.”
\end{itemize}
...
At the beginning of the 6th, 9th, and 12th rounds, remove all Black cubes from all Water Wheels and Windmills on the map. Additionally, all players possessing the title of “\textcolor{cyan}{Grail Knight}” gain \svg{morale_positive}. Finally, any players who do not possess a title gain 2 \svg{morale_negative}.
\begin{tikzpicture}
    \centering
    \includegraphics[width=1\linewidth]{\_assets/maps/bloody-grail-2p.png}
\end{tikzpicture}
\end{multicols*}
...
%\centering
%\includegraphics[width=0.2\paperwidth]{\_assets/maps/bloody-grail-4p.png}
