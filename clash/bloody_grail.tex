...
If the Grail token has been obtained, the players gain additional time (until the end of the 16th round) to bring the Grail to their faction's Town. Otherwise, all players lose the scenario.

\subsection*{\MakeUppercase{Timed Events}}

\textbf{6$^{th}$, 9$^{th}$ and 12$^{th}$ Rounds:}
\begin{itemize}
...
\begin{tikzpicture}[overlay]
  \centering
  \node at (4.5, -5) {\includegraphics[scale=0.45]{\_assets/maps/bloody-grail-2p.png}};
  \node at (4.5, -10) {\footnotesize{\textbf{\MakeUppercase{2-PLAYER SCENARIO}}}};
  \node at (12.1, -14) {\includegraphics[scale=0.45]{\_assets/maps/bloody-grail-4p.png}};
