...
\begin{itemize}
  ...
  \begin{enumerate}[leftmargin=15pt]
    ...
    \begin{enumerate}
      \item \textbf{[1st Obelisk]} You gain a Secondary Hero. Place their model on this Field. If you already have a Secondary Hero, gain 6 \svg{gold} instead. Then, choose one enemy player to discard 1 random Card from their hand.
