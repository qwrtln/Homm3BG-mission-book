...
\begin{itemize}
  ...
  \item 4 × Near (IV--V) Map Tile, 4 of which must contain an Obelisk
  \item 4 × Far (II--III) Map Tile, 2 of which must contain a Settlement
  \item 1 × Center (VI--VII) Map Tile with the Grail Field
\end{itemize}
...
\begin{itemize}
  ...
  \begin{enumerate}[leftmargin=15pt]
    ...
    \end{enumerate}
    \vspace*{\fill}\columnbreak
    \item \textbf{[Sacrifice]} Exchange a * Faction Unit Card from your Unit Deck for:
    \begin{enumerate}
