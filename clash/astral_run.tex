...
\begin{itemize}
  \item \textbf{Grail Token:} When gained, Search (4) \svg{artifact}. \svg{hand} Limit is increased by 3.
  ...
  \item \textbf{Center Obelisk:} Search (3) your deck twice. \textit{(Worth 2VP, the blocked Field is not considered blocked.)}
\end{itemize}
