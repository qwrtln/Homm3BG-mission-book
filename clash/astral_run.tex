...
\begin{itemize}
  ...
  \item 6 × Near (IV--V) Map Tiles with an Obelisk
...
\begin{itemize}
  ...
  \item \textbf{4--6 players:} One player has defeated every opponent's Main Hero at least once. \textit{That player wins the game immediately.}
...
\begin{itemize}
  ...
  \item \textbf{Obelisk:} Guarded by Level VI Neutral Units. Search (4) \svg[8]{skill}, \svg{spellpower} or \svg{artifact}. \\ \textbf{First to Flag:} Gain Empowered Ability Token.
...
\begin{itemize}
  \item \textbf{Grail Token:} When gained, Search~(4) \svg{artifact}. Your \svg{hand} Limit is increased by 3.
  \item \textbf{Level VII Settlement:} Reinforce one \svg{silver} Unit for free and increase two incomes by 1 space.
  \item \textbf{Random Town:} Gain 10~\svg{gold}. You may recruit and reinforce one Faction Unit you defeated for half the \svg{gold} cost.
  \item \textbf{Dragon Utopia:} Take any Card from your Discard Pile. You may recruit one dragon you defeated for half its recruitment cost or gain 10~\svg{gold}.
  \item \textbf{11-Round game:} Remove $P$~×~Near \mbox{(IV--V)} Map Tiles and replace the Center \mbox{(VI--VII)} Tile with a Near \mbox{(IV--V)} Map Tile without an Obelisk.
\end{itemize}

\begin{center}
  \hspace*{-1em}\includegraphics[width=1.12\linewidth]{\maps/astral_run_short.png}
  \vspace*{-1em}
