...
\addscenariosection{1}{Clash Scenario}{Dragoncurse Castle}{\images/town_portal.png}
...
\begin{itemize}
  \item 2 × A Few \svg{bronze} Units with the lowest Recruitment cost
\end{itemize}
...
\vfill
\begin{center}
  \transparent{0.2}{\includegraphics[width=\linewidth, keepaspectratio]{\art/vision.png}}
\end{center}
...
\begin{itemize}
  \item Whenever an Obelisk is Visited for the first time, the Visiting player rolls 2 \svg{resource} and resolves both results.
  ...
  \item Like any other Town, when the Random Town is owned by a player, it is a valid location for that player to:
    ...
    \end{itemize}
  \item The first player to Visit the Dragon Utopia (after defeating the defending \svg{azure} Unit(s)) draws Cards from the Neutral Units \svg{azure} Deck until a Dragon not associated with any Faction is drawn.
...
\vfill
\begin{center}
  \transparent{0.2}{\includegraphics[width=\linewidth, keepaspectratio]{\images/earthquake.png}}
\end{center}
\vfill
\phantom{.}
\end{multicols}
