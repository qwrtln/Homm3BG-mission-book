...
\begin{tikzpicture}[overlay]
  \centering
  \node at (14, 5) {\includegraphics[width=\linewidth]{\_assets/maps/force-of-will-2p.png}};
  \node at (14, -2) {\footnotesize{\textbf{\MakeUppercase{2-PLAYER SCENARIO}}}};
  \node at (7, -6) {\includegraphics[width=1.35\linewidth]{\_assets/maps/force-of-will-3p.png}};
  \node at (7, -12.5) {\footnotesize{\textbf{\MakeUppercase{3-PLAYER SCENARIO}}}};
\end{tikzpicture}
