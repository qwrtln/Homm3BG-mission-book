...
\begin{tikzpicture}[overlay]
  \centering
  \node at (14, 6.5) {\includegraphics[width=0.4\linewidth]{\_assets/maps/force-of-will-2p.png}};
  \node at (14, 0.5) {\footnotesize{\textbf{\MakeUppercase{2-PLAYER SCENARIO}}}};
  \node at (7, -6) {\includegraphics[width=0.4\linewidth]{\_assets/maps/force-of-will-3p.png}};
