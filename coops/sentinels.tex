...
\begin{tikzpicture}[overlay, anchor=north west]
  \node {\includegraphics[width=\columnwidth, keepaspectratio]{\art/berserk.png}};
\end{tikzpicture}
\vspace*{\fill}\columnbreak
...
\begin{tikzpicture}[overlay, anchor=north west]
  \node {\includegraphics[width=\columnwidth, keepaspectratio]{\maps/sentinels.png}};
\end{tikzpicture}
