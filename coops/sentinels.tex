...
\begin{itemize}
  ...
  \item ``Few'' \svg{bronze} Units with the \textit{highest} Recruitment cost
\end{itemize}
...
\begin{itemize}
  ...
  \item Enemy armies have 3 \svg{movement} per Round.
  \item Enemy armies move at the end of every Round, starting with the Round they spawned.
...
\begin{itemize}
  \item Fighting enemy armies over more than one Combat Round does not cost \svg{movement}.
  \item During a battle with an enemy army, a Hero can retreat whenever a friendly Unit is about to Activate.
    A retreating Main Hero loses all remaining \svg{movement} and is returned to an allied Town or Settlement of their choice, keeping all remaining Units.
...
\begin{itemize}
  ...
  \item Place the Reinforcing Units on the enemy backline, starting from the left with the lowest Initiative (\svg{unit_ranged} Units first). If necessary, continue on the next line in the same order.
  \item When a player retreats, the enemy army draws up to a minimum of 4 Units and takes these as starting Units to the next fight.
\end{itemize}
...
\hommtable[]{20}{
  ...
  \begin{tabularx}{0.95\linewidth}{p{0.15\linewidth}XXXX} & \darkcell{Rounds 6 + 7} & \darkcell{Rounds 8 + 9} & \darkcell{Round 10}\\
  \darkcell[1.4]{Easy}
    & \lightcell[1.4]{\svg[12]{bronze}\svg[12]{silver}\svg[12]{silver}\svg[12]{silver}\svg[12]{golden}}
    & \lightcell[1.4]{\svg[12]{silver}\svg[12]{silver}\svg[12]{silver}\svg[12]{golden}\svg[12]{golden}}
    & \lightcell[1.4]{\svg[12]{silver}\svg[12]{silver}\svg[12]{golden}\svg[12]{azure}\footref{azure} \linebreak
      (2\svg[12]{bronze}, 4\svg[12]{silver}, 3\svg[12]{golden}, 1\svg[12]{azure})}\\
  \darkcell[1.4]{Normal}
    & \lightcell[1.4]{\svg[12]{silver}\svg[12]{silver}\svg[12]{silver}\svg[12]{golden}\svg[12]{golden}}
    & \lightcell[1.4]{\svg[12]{silver}\svg[12]{silver}\svg[12]{silver}\svg[12]{golden}\svg[12]{azure}}
    & \lightcell[1.4]{\svg[12]{golden}\svg[12]{golden}\svg[12]{golden}\svg[12]{azure}\footref{azure} \linebreak
      (2\svg[12]{silver}, 7\svg[12]{golden}, 1\svg[12]{azure})}\\
  \darkcell[1.4]{Hard}
    & \lightcell[1.4]{\svg[12]{silver}\svg[12]{silver}\svg[12]{golden}\svg[12]{golden}\svg[12]{golden}}
    & \lightcell[1.4]{\svg[12]{silver}\svg[12]{silver}\svg[12]{golden}\svg[12]{golden}\svg[12]{azure}}
    & \lightcell[1.4]{\svg[12]{golden}\svg[12]{golden}\svg[12]{azure}\svg[12]{azure}\footref{azure} \linebreak
      (2\svg[12]{silver}, 6\svg[12]{golden}, 2\svg[12]{azure})}\\
  \darkcell[1.4]{Impossible}
    & \lightcell[1.4]{\svg[12]{silver}\svg[12]{golden}\svg[12]{golden}\svg[12]{golden}\svg[12]{golden}}
    & \lightcell[1.4]{\svg[12]{golden}\svg[12]{golden}\svg[12]{golden}\svg[12]{golden}\svg[12]{azure}}
    & \lightcell[1.4]{\svg[12]{golden}\svg[12]{azure}\svg[12]{azure}\svg[12]{azure}\footref{azure} \linebreak
      (7\svg[12]{golden}, 3\svg[12]{azure})}\\
  \end{tabularx}
}
...
\footnotetext{Always 1 Unit of Azure Dragons (starting Units of Boss Army). The rest is random\label{azure}.}
