...
\begin{itemize}
  ...
  \item Enemy armies have 3 \svgeven{movement} per Round.
...
\begin{itemize}
  \item Fighting enemy armies over more than one Combat Round does not cost \svgeven{movement}.
  \item During a battle with an enemy army, a Hero can retreat whenever a friendly Unit is about to Activate.
    A retreating Main Hero loses all remaining \svgeven{movement} and is returned to an allied Town or Settlement of their choice, keeping all remaining Units.
