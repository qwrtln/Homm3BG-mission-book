...
\addscenariosection{1}{Cooperative Scenario}{Siemano}{\images/logistics.png}
...
\begin{tikzpicture}[overlay]
  \node(bg)[anchor=center, opacity=0.07, xshift=-2em, yshift=-23em] at (current page.south) {
    \includegraphics[width=1.2\paperwidth, keepaspectratio]{\art/ammo_cart.png}
  };
\end{tikzpicture}
\vfill
...
\begin{minipage}{0.4\paperwidth}
  \centering
  \includegraphics[width=0.25\paperwidth]{\maps/emerald-2.png}
...
\begin{minipage}{0.4\paperwidth}
  \hfill
  \includegraphics[width=0.35\paperwidth]{\maps/emerald-3.png}
  \captionof{figure}{\textbf{3-PLAYER SCENARIO}}
\end{minipage}
\begin{minipage}{0.4\paperwidth}
  \vspace{1em}
  \hfill
  \includegraphics[width=0.46\paperwidth]{\maps/emerald-4.png}
