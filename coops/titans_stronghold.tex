...
\begin{tikzpicture}[overlay]
  \node[inner sep=0pt, opacity=0.3] at (0, -6.2) {\includegraphics[width=0.75\linewidth, keepaspectratio]{\art/shackles_of_war.png}};
\end{tikzpicture}
...
\begin{center}
  \includegraphics[width=0.8\linewidth, keepaspectratio]{\art/dimension_door.png}
\end{center}
\vspace*{\fill}
...
\begin{tikzpicture}[overlay, every node/.style={anchor=base}]
  \centering

  \matrix [matrix anchor=north west, column sep=1em]
  {
    \node {\includegraphics[width=\textwidth/2-1em, height=\textheight/3-4em, keepaspectratio]{\maps/titans-1.png}}; &
    \node {\includegraphics[width=\textwidth/2-1em, height=\textheight/3-4em, keepaspectratio]{\maps/titans-2.png}}; \\
    \node {\textbf{1-PLAYER SCENARIO}}; &
    \node {\textbf{2-PLAYER SCENARIO}}; \\[1em]
    \node {\includegraphics[width=\textwidth/2-1em, height=\textheight/3-4em, keepaspectratio]{\maps/titans-3.png}}; &
    \node {\includegraphics[width=\textwidth/2-1em, height=\textheight/3-4em, keepaspectratio]{\maps/titans-4.png}}; \\
    \node {\textbf{3-PLAYER SCENARIO}}; &
    \node {\textbf{4-PLAYER SCENARIO}}; \\[1em]
    \node {\includegraphics[width=\textwidth/2-1em, height=\textheight/3-4em, keepaspectratio]{\maps/titans-5.png}}; &
    \node {\includegraphics[width=\textwidth/2-1em, height=\textheight/3-4em, keepaspectratio]{\maps/titans-6.png}}; \\
    \node {\textbf{5-PLAYER SCENARIO}}; &
    \node {\textbf{6-PLAYER SCENARIO}}; \\
  };
\end{tikzpicture}
