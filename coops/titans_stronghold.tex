...
\begin{itemize}
  ...
  \item Combat in the Titans' Stronghold now costs 1 \svgeven{movement} to extend per Combat Round, just like Combat against non-Azure tier Units.
...
\begin{center}
  \transparent{0.2}{\includegraphics[width=0.6\linewidth, keepaspectratio]{\art/land_mine.png}}
\end{center}
