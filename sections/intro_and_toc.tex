...
\begin{center}
  ...
  It is community-driven, and has a \hrefwithoutfootnote{\repourl}{GitHub repository}.
  ...
  \begin{multicols}{3}
    ...
    \includegraphics[width=0.8\linewidth]{\qr/form.png} \\
    Scan to open Scenario \textbf{feedback form}.\\
