...
Standard Grail rules apply: spend 2 \svg{movement} to dig it up, and bring it to your Town.
\vspace*{\fill}
\columnbreak
...
\begin{table*}
  \hommtable[]{27}{
    ...
    \darkcell[1.4]{Army}
      & \lightcellleft[1.4]{2 × ``Few'' cheapest \svg[12]{bronze} Units}
      & \lightcellleft[1.4]{Pack of cheap \svg[12]{bronze} Units \linebreak ``Few'' chosen \svg[12]{bronze} Units}
      & \lightcellleft[1.4]{Pack of chosen \svg[12]{bronze} Units \linebreak ``Few'' cheap \svg[12]{silver} Units}\\
    ...
    \darkcell[2.0]{Town Buildings}
      & \lightcellleft[2.0]{\svg[12]{bronze} Dwelling}
      & \lightcellleft[2.0]{\svg[12]{bronze} Dwelling \linebreak City Hall}
      & \lightcellleft[2.0]{\svg[12]{bronze} Dwelling \linebreak City Hall \linebreak Citadel}\\
    \end{tabularx}
  }
\end{table*}
