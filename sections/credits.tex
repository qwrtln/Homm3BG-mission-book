...
\textbf{Contributing scenarios in \LaTeX{}:} Andrzej Wiącek, Tomáš Zeman, Xavier Borelly, Justus Törmälehto, Saveliy Ivanov, Tyson Heckert, Adam Obuchowicz, Vojtěch Růžička, Christian Jakobsen.  % no-check-caps
...
{\tikz[transparency group]\node[opacity=0.2]{\includegraphics[width=1.3\linewidth]{\art/genie.png}};}
